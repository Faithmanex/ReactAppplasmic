...
import sty from "./PlasmicButton.module.css"; // plasmic-import: gT-lQgwg5epa/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__cIt5O)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mZuLy)}
                role={"img"}
              />
            ),
