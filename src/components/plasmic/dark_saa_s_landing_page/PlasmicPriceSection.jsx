...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: 0epNN3jGtaHL/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bv9Ap)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__uTkaf)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard___5SeBo)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__gC3E)}>
          <div className={classNames(projectcss.all, sty.freeBox__zzS57)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard___3SNt)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__z1Gft)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__cz5R5)}
          />
        </div>
      </Stack__>
    </div>
